...
module VexiiRiscv (
  ...
  reg        [42:0]   BtbPlugin_logic_mem_spinal_port1;
  ...
  wire       [42:0]   _zz_BtbPlugin_logic_mem_port;
  ...
  reg                 decode_ctrls_2_up_DispatchPlugin_logic_hcs_0_onRs_1_ENABLES_1_0;
  ...
  wire       [42:0]   _zz_BtbPlugin_logic_readPort_rsp_0_hash;
  ...
  (* ram_style = "block" *) reg [42:0] BtbPlugin_logic_mem [0:127];
  ...
  assign _zz_when_2 = LsuPlugin_logic_storeBuffer_push_payload_slotOh[1];
  ...
  assign _zz_26 = _zz_execute_ctrl4_down_LsuL1Plugin_logic_MUXED_DATA_lane0;
  assign _zz_28 = {_zz_14[2],{_zz_14[1],_zz_14[0]}};
  ...
  always @(*) begin
    ...
    if(LsuL1Plugin_logic_ls_ctrl_bankWriteReservation_win) begin
      LsuL1Plugin_logic_banksWrite_address = execute_ctrl4_down_LsuL1_PHYSICAL_ADDRESS_lane0[10 : 3];
    end
  end
  ...
  always @(*) begin
    ...
    if(LsuL1Plugin_logic_ls_ctrl_doRefill) begin
      LsuL1Plugin_logic_writeback_push_payload_address = ({6'd0,{execute_ctrl4_down_LsuL1Plugin_logic_WAYS_TAGS_lane0_0_address,execute_ctrl4_down_LsuL1_MIXED_ADDRESS_lane0[10 : 6]}} <<< 3'd6);
    end
  end
  ...
  assign LsuL1Plugin_logic_ls_rb0_readAddress = execute_ctrl2_down_LsuL1_MIXED_ADDRESS_lane0[10 : 3];
  ...
  assign execute_ctrl3_down_LsuL1Plugin_logic_WAYS_HITS_lane0[0] = (execute_ctrl3_down_LsuL1Plugin_logic_WAYS_TAGS_lane0_0_loaded && (execute_ctrl3_down_LsuL1Plugin_logic_WAYS_TAGS_lane0_0_address == execute_ctrl3_down_LsuL1_PHYSICAL_ADDRESS_lane0[31 : 11]));
  ...
  assign _zz_14 = {LsuL1Plugin_logic_ls_ctrl_askRefill,{LsuL1Plugin_logic_ls_ctrl_doUpgrade,LsuL1Plugin_logic_ls_ctrl_doFlush}};
  always @(*) begin
  ...
  assign _zz_16 = ({1'd0,1'b1} <<< FetchCachelessPlugin_logic_buffer_reserveId_value);
  always @(*) begin
  ...
  assign _zz_17 = ({1'd0,1'b1} <<< FetchCachelessPlugin_logic_bus_rsp_payload_id);
  ...
  assign when_BranchPlugin_l244 = (early0_BranchPlugin_logic_jumpLogic_doIt && execute_ctrl3_down_early0_BranchPlugin_logic_jumpLogic_MISSALIGNED_lane0);
  ...
  assign lane0_IntFormatPlugin_logic_stages_2_hits = {LsuPlugin_logic_iwb_valid,{late0_BarrelShifterPlugin_logic_wb_valid,late0_IntAluPlugin_logic_wb_valid}};
  ...
  assign _zz_BtbPlugin_logic_readPort_rsp_0_hash = BtbPlugin_logic_mem_spinal_port1[42 : 0];
  ...
  assign BtbPlugin_logic_readPort_rsp_0_pcTarget = _zz_BtbPlugin_logic_readPort_rsp_0_hash[38 : 9];
  assign BtbPlugin_logic_readPort_rsp_0_isBranch = _zz_BtbPlugin_logic_readPort_rsp_0_hash[39];
  assign BtbPlugin_logic_readPort_rsp_0_isPush = _zz_BtbPlugin_logic_readPort_rsp_0_hash[40];
  assign BtbPlugin_logic_readPort_rsp_0_isPop = _zz_BtbPlugin_logic_readPort_rsp_0_hash[41];
  assign BtbPlugin_logic_readPort_rsp_0_taken = _zz_BtbPlugin_logic_readPort_rsp_0_hash[42];
  ...
  assign decode_logic_flushes_2_onLanes_0_doIt = (|{(late0_BranchPlugin_logic_flushPort_valid && 1'b1),{(early0_EnvPlugin_logic_flushPort_valid && 1'b1),{(CsrAccessPlugin_logic_flushPort_valid && 1'b1),{(early0_BranchPlugin_logic_flushPort_valid && 1'b1),(LsuPlugin_logic_flushPort_valid && 1'b1)}}}});
  ...
  assign _zz_TrapPlugin_logic_harts_0_trap_pending_arbiter_ports_4_valid = (FetchCachelessPlugin_logic_trapPort_valid && 1'b1);
  ...
  assign TrapPlugin_logic_harts_0_trap_pending_arbiter_ports_4_payload_exception = FetchCachelessPlugin_logic_trapPort_payload_exception;
  assign TrapPlugin_logic_harts_0_trap_pending_arbiter_ports_4_payload_tval = FetchCachelessPlugin_logic_trapPort_payload_tval;
  assign TrapPlugin_logic_harts_0_trap_pending_arbiter_ports_4_payload_code = FetchCachelessPlugin_logic_trapPort_payload_code;
  assign TrapPlugin_logic_harts_0_trap_pending_arbiter_ports_4_payload_arg = FetchCachelessPlugin_logic_trapPort_payload_arg;
  ...
  assign _zz_29 = zz_FetchCachelessPlugin_logic_trapPort_payload_arg(1'b0);
  always @(*) FetchCachelessPlugin_logic_trapPort_payload_arg = _zz_29;
  ...
  assign _zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0 = ((execute_lane0_logic_decoding_decodingBits & 33'h000001058) == 33'h000001008);
  always @(*) begin
  ...
  assign TrapPlugin_logic_initHold = (|{(! CsrRamPlugin_logic_flush_done),{((! LsuL1Plugin_logic_initializer_done) || 1'b0),{(! integer_RegFilePlugin_logic_initalizer_done),1'b0}}});
  ...
  assign decode_ctrls_2_down_DispatchPlugin_logic_hcs_0_onRs_1_ENABLES_1_0 = decode_ctrls_2_up_DispatchPlugin_logic_hcs_0_onRs_1_ENABLES_1_0;
  ...
  always @(posedge clk or posedge reset) begin
    if(reset) begin
      ...
      if(execute_ctrl4_down_LsuL1_SEL_lane0) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_25 <= 1'b1)); // LsuL1Plugin.scala:L855
          `else
            if(!(_zz_25 <= 1'b1)) begin
      ...
      if(when_LsuL1Plugin_l876) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_27 < 2'b10)); // LsuL1Plugin.scala:L877
          `else
            if(!(_zz_27 < 2'b10)) begin
  ...
  always @(posedge clk) begin
    ...
    if(decode_ctrls_1_down_isReady) begin
      ...
      decode_ctrls_2_up_DispatchPlugin_logic_hcs_0_onRs_1_ENABLES_1_0 <= decode_ctrls_1_down_DispatchPlugin_logic_hcs_0_onRs_1_ENABLES_1_0;
