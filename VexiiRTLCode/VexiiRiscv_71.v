...
module VexiiRiscv (
  ...
  reg        [4:0]    LsuPlugin_logic_storeBuffer_slots_1_ptr;
  ...
  reg [0:0] FetchL1Plugin_logic_plru_mem [0:3];
  ...
  assign _zz_execute_ctrl1_down_COMPLETION_AT_2_lane0_1 = (|{_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_1,{_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0,{_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_3,_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_2}}});
  ...
  assign _zz_41 = {_zz_execute_ctrl4_down_LsuL1Plugin_logic_MUXED_DATA_lane0_1,_zz_execute_ctrl4_down_LsuL1Plugin_logic_MUXED_DATA_lane0};
  ...
  assign _zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_2 = ((execute_lane0_logic_decoding_decodingBits & 32'h00001058) == 32'h00001008);
  always @(*) begin
  ...
  always @(posedge clk or posedge reset) begin
    if(reset) begin
      ...
      if(execute_ctrl4_down_LsuL1_SEL_lane0) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_40 <= 2'b01)); // LsuL1Plugin.scala:L855
          `else
      ...
      if(when_LsuL1Plugin_l876) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_42 < 2'b10)); // LsuL1Plugin.scala:L877
          `else
