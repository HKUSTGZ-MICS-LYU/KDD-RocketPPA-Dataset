...
module VexiiRiscv (
  ...
  wire       [48:0]   _zz_BtbPlugin_logic_readPort_rsp_0_hash;
  ...
  reg [6:0] LsuL1Plugin_logic_shared_mem [0:15];
  reg [31:0] LsuL1Plugin_logic_writeback_victimBuffer [0:31];
  (* ram_style = "block" *) reg [48:0] BtbPlugin_logic_mem [0:31];
  ...
  assign _zz_BtbPlugin_logic_readPort_rsp_0_hash = BtbPlugin_logic_mem_spinal_port1[48 : 0];
