...
module VexiiRiscv (
  ...
  reg        [31:0]   execute_ctrl3_up_early0_BarrelShifterPlugin_SHIFT_RESULT_lane0;
  ...
  reg                 _zz_5;
  reg                 _zz_6;
  wire       [31:0]   execute_ctrl3_down_early0_BarrelShifterPlugin_SHIFT_RESULT_lane0;
  ...
  assign LsuL1Plugin_logic_ls_ctrl_refillHazards = (LsuL1Plugin_logic_refill_slots_0_valid && (LsuL1Plugin_logic_refill_slots_0_address[9 : 6] == execute_ctrl4_down_LsuL1_PHYSICAL_ADDRESS_lane0[9 : 6]));
  ...
  assign _zz_17 = ({1'd0,1'b1} <<< FetchCachelessPlugin_logic_buffer_reserveId_value);
  always @(*) begin
  ...
  assign _zz_18 = ({1'd0,1'b1} <<< FetchCachelessPlugin_logic_bus_rsp_payload_id);
  ...
  assign lane0_IntFormatPlugin_logic_stages_1_raw = ((lane0_IntFormatPlugin_logic_stages_1_hits[0] ? early0_BarrelShifterPlugin_logic_wb_payload : 32'h0) | (lane0_IntFormatPlugin_logic_stages_1_hits[1] ? CsrAccessPlugin_logic_wbWi_payload : 32'h0));
  ...
  assign lane0_IntFormatPlugin_logic_stages_2_raw = (((lane0_IntFormatPlugin_logic_stages_2_hits[0] ? late0_IntAluPlugin_logic_wb_payload : 32'h0) | (lane0_IntFormatPlugin_logic_stages_2_hits[1] ? late0_BarrelShifterPlugin_logic_wb_payload : 32'h0)) | (lane0_IntFormatPlugin_logic_stages_2_hits[2] ? LsuPlugin_logic_iwb_payload : 32'h0));
  always @(*) begin
  ...
  assign AlignerPlugin_logic_extractors_0_ctx_hm_GSharePlugin_GSHARE_COUNTER_0 = fetch_logic_ctrls_1_down_GSharePlugin_GSHARE_COUNTER_0;
  assign AlignerPlugin_logic_extractors_0_ctx_hm_Prediction_BRANCH_HISTORY = fetch_logic_ctrls_1_down_Prediction_BRANCH_HISTORY;
  ...
  assign _zz_32 = zz_FetchCachelessPlugin_logic_trapPort_payload_arg(1'b0);
  always @(*) FetchCachelessPlugin_logic_trapPort_payload_arg = _zz_32;
  ...
  assign _zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_3 = ((execute_lane0_logic_decoding_decodingBits & 33'h000001048) == 33'h000001008);
  always @(*) begin
