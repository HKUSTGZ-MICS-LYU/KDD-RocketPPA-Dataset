...
module VexiiRiscv (
  ...
  (* ram_style = "block" *) reg [49:0] BtbPlugin_logic_mem [0:63];
  reg [63:0] FetchL1Plugin_logic_banks_0_mem [0:127];
  reg [63:0] FetchL1Plugin_logic_banks_1_mem [0:127];
  ...
  assign FetchL1Plugin_logic_banks_0_read_cmd_payload = fetch_logic_ctrls_0_down_Fetch_WORD_PC[9 : 3];
  assign FetchL1Plugin_logic_banks_1_read_cmd_valid = FetchL1Plugin_logic_cmd_doIt;
  assign FetchL1Plugin_logic_banks_1_read_cmd_payload = fetch_logic_ctrls_0_down_Fetch_WORD_PC[9 : 3];
  ...
  assign _zz_19 = zz_FetchL1Plugin_logic_trapPort_payload_arg(1'b0);
  always @(*) FetchL1Plugin_logic_trapPort_payload_arg = _zz_19;
  always @(*) begin
  ...
  assign fetch_logic_ctrls_1_down_BtbPlugin_logic_chunksLogic_0_hitCalc_HIT = ((fetch_logic_ctrls_1_down_BtbPlugin_logic_chunksLogic_0_readRsp_ENTRY_hash == fetch_logic_ctrls_1_down_Fetch_WORD_PC[23 : 8]) && 1'b1);
