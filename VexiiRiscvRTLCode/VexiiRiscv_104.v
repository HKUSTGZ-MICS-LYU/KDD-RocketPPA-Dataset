...
module VexiiRiscv (
  ...
  assign _zz_execute_ctrl1_down_COMPLETION_AT_2_lane0_1 = (|{_zz_execute_ctrl1_down_BYPASSED_AT_3_lane0,{_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0,{_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_4,{_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_3,{_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_1,_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_2}}}}});
  ...
  assign _zz_29 = _zz_execute_ctrl4_down_LsuL1Plugin_logic_MUXED_DATA_lane0;
  assign _zz_31 = {_zz_15[2],{_zz_15[1],_zz_15[0]}};
  ...
  always @(*) begin
    ...
    if(LsuL1Plugin_logic_ls_ctrl_bankWriteReservation_win) begin
      LsuL1Plugin_logic_banksWrite_address = execute_ctrl4_down_LsuL1_PHYSICAL_ADDRESS_lane0[8 : 3];
    end
  end
  ...
  assign LsuL1Plugin_logic_ls_rb0_readAddress = execute_ctrl2_down_LsuL1_MIXED_ADDRESS_lane0[8 : 3];
  ...
  assign _zz_15 = {LsuL1Plugin_logic_ls_ctrl_askRefill,{LsuL1Plugin_logic_ls_ctrl_doUpgrade,LsuL1Plugin_logic_ls_ctrl_doFlush}};
  always @(*) begin
  ...
  assign fetch_logic_ctrls_2_down_Fetch_WORD = fetch_logic_ctrls_2_down_FetchL1Plugin_logic_BANKS_MUXES_0;
  ...
  assign _zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_1 = ((execute_lane0_logic_decoding_decodingBits & 33'h000001058) == 33'h000001008);
  always @(*) begin
  ...
  always @(posedge clk or posedge reset) begin
    if(reset) begin
      ...
      if(execute_ctrl4_down_LsuL1_SEL_lane0) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_28 <= 1'b1)); // LsuL1Plugin.scala:L855
          `else
            if(!(_zz_28 <= 1'b1)) begin
      ...
      if(when_LsuL1Plugin_l876) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_30 < 2'b10)); // LsuL1Plugin.scala:L877
          `else
...
module DivRadix (
  ...
  assign when_DivRadix_l41 = (busy && (counter == 6'h3f));
  assign div2 = (div1 <<< 1);
  ...
  assign when_DivRadix_l64 = (! sub1[65]);
