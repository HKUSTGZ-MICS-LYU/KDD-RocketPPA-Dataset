...
module VexiiRiscv (
  ...
  reg        [20:0]   execute_ctrl3_up_LsuL1Plugin_logic_WAYS_TAGS_lane0_0_address;
  ...
  reg        [0:0]    execute_ctrl2_up_LsuL1Plugin_logic_ls_rt0_SHARED_BYPASS_VALUE_lane0_dirty;
  ...
  wire       [63:0]   execute_ctrl3_down_LsuL1_WRITE_DATA_lane0;
  ...
  wire       [20:0]   execute_ctrl2_down_LsuL1Plugin_logic_WAYS_TAGS_lane0_0_address;
  ...
  wire       [0:0]    execute_ctrl1_down_LsuL1Plugin_logic_ls_rt0_SHARED_BYPASS_VALUE_lane0_dirty;
  ...
  wire       [63:0]   lane0_IntFormatPlugin_logic_stages_1_wb_payload;
  ...
  reg [0:0] LsuL1Plugin_logic_shared_mem [0:31];
  reg [63:0] LsuL1Plugin_logic_writeback_victimBuffer [0:15];
  (* ram_style = "block" *) reg [41:0] BtbPlugin_logic_mem [0:63];
  ...
  assign _zz_LsuL1Plugin_logic_ls_ctrl_refillWayNeedWriteback = (execute_ctrl3_down_LsuL1Plugin_logic_WAYS_TAGS_lane0_0_loaded & execute_ctrl3_down_LsuL1Plugin_logic_SHARED_lane0_dirty);
  assign _zz_LsuL1Plugin_logic_ls_ctrl_doWrite = (_zz_execute_ctrl3_down_LsuL1Plugin_logic_MUXED_DATA_lane0 ? (1'b1 && (! execute_ctrl3_down_LsuL1Plugin_logic_WAYS_TAGS_lane0_0_fault)) : 1'b0);
  ...
  assign _zz_LsuPlugin_logic_flusher_cmdCounter = execute_ctrl3_down_LsuL1_MIXED_ADDRESS_lane0[10 : 6];
  ...
  assign _zz_61 = _zz_execute_ctrl3_down_LsuL1Plugin_logic_MUXED_DATA_lane0;
  assign _zz_63 = {_zz_21[2],{_zz_21[1],_zz_21[0]}};
  ...
  always @(*) begin
    ...
    if(LsuL1Plugin_logic_ls_ctrl_bankWriteReservation_win) begin
      LsuL1Plugin_logic_banksWrite_address = execute_ctrl3_down_LsuL1_PHYSICAL_ADDRESS_lane0[10 : 3];
    end
  end
  ...
  always @(*) begin
    ...
    if(LsuL1Plugin_logic_ls_ctrl_doFlush) begin
      LsuL1Plugin_logic_waysWrite_address = execute_ctrl3_down_LsuL1_MIXED_ADDRESS_lane0[10 : 6];
    end
    if(when_LsuL1Plugin_l1160) begin
  ...
  always @(*) begin
    ...
    if(LsuL1Plugin_logic_ls_ctrl_doFlush) begin
      LsuL1Plugin_logic_writeback_push_payload_address = ({6'd0,{_zz_LsuL1Plugin_logic_waysWrite_tag_address,execute_ctrl3_down_LsuL1_MIXED_ADDRESS_lane0[10 : 6]}} <<< 3'd6);
    end
    if(LsuL1Plugin_logic_ls_ctrl_doRefill) begin
      LsuL1Plugin_logic_writeback_push_payload_address = ({6'd0,{execute_ctrl3_down_LsuL1Plugin_logic_WAYS_TAGS_lane0_0_address,execute_ctrl3_down_LsuL1_MIXED_ADDRESS_lane0[10 : 6]}} <<< 3'd6);
    end
  end
  ...
  assign LsuL1Plugin_logic_ls_rb0_readAddress = execute_ctrl1_down_LsuL1_MIXED_ADDRESS_lane0[10 : 3];
  ...
  assign execute_ctrl2_down_LsuL1Plugin_logic_BANK_BUSY_REMAPPED_lane0[0] = (execute_ctrl2_down_LsuL1Plugin_logic_BANK_BUSY_lane0[0] || LsuL1Plugin_logic_ls_rb1_onBanks_0_busyReg);
  ...
  assign execute_ctrl3_down_LsuL1Plugin_logic_MUXED_DATA_lane0 = (_zz_execute_ctrl3_down_LsuL1Plugin_logic_MUXED_DATA_lane0 ? execute_ctrl3_down_LsuL1Plugin_logic_BANKS_MUXES_lane0_0 : 64'h0);
  always @(*) begin
  ...
  assign LsuL1Plugin_logic_shared_lsuRead_cmd_payload = execute_ctrl1_down_LsuL1_MIXED_ADDRESS_lane0[10 : 6];
  assign execute_ctrl1_down_LsuL1Plugin_logic_ls_rt0_SHARED_BYPASS_VALID_lane0 = (LsuL1Plugin_logic_shared_write_valid && (LsuL1Plugin_logic_shared_write_payload_address == execute_ctrl1_down_LsuL1_MIXED_ADDRESS_lane0[10 : 6]));
  ...
  assign LsuL1Plugin_logic_ways_0_lsuRead_cmd_payload = execute_ctrl1_down_LsuL1_MIXED_ADDRESS_lane0[10 : 6];
  always @(*) begin
  ...
  assign LsuL1Plugin_logic_ls_sharedBypassers_0_hit = (LsuL1Plugin_logic_shared_write_valid && (LsuL1Plugin_logic_shared_write_payload_address == execute_ctrl2_down_LsuL1_MIXED_ADDRESS_lane0[10 : 6]));
  ...
  assign execute_ctrl2_down_LsuL1Plugin_logic_WAYS_HITS_lane0[0] = (execute_ctrl2_down_LsuL1Plugin_logic_WAYS_TAGS_lane0_0_loaded && (execute_ctrl2_down_LsuL1Plugin_logic_WAYS_TAGS_lane0_0_address == execute_ctrl2_down_LsuL1_PHYSICAL_ADDRESS_lane0[31 : 11]));
  ...
  assign LsuL1Plugin_logic_ls_ctrl_refillHazards = {(LsuL1Plugin_logic_refill_slots_1_valid && (LsuL1Plugin_logic_refill_slots_1_address[10 : 6] == execute_ctrl3_down_LsuL1_PHYSICAL_ADDRESS_lane0[10 : 6])),(LsuL1Plugin_logic_refill_slots_0_valid && (LsuL1Plugin_logic_refill_slots_0_address[10 : 6] == execute_ctrl3_down_LsuL1_PHYSICAL_ADDRESS_lane0[10 : 6]))};
  assign LsuL1Plugin_logic_ls_ctrl_writebackHazards = {(LsuL1Plugin_logic_writeback_slots_1_valid && (LsuL1Plugin_logic_writeback_slots_1_address[10 : 6] == execute_ctrl3_down_LsuL1_PHYSICAL_ADDRESS_lane0[10 : 6])),(LsuL1Plugin_logic_writeback_slots_0_valid && (LsuL1Plugin_logic_writeback_slots_0_address[10 : 6] == execute_ctrl3_down_LsuL1_PHYSICAL_ADDRESS_lane0[10 : 6]))};
  ...
  assign LsuL1Plugin_logic_ls_ctrl_loadedDirties = (execute_ctrl3_down_LsuL1Plugin_logic_WAYS_TAGS_lane0_0_loaded & execute_ctrl3_down_LsuL1Plugin_logic_SHARED_lane0_dirty);
  ...
  assign execute_ctrl3_down_LsuL1_WAIT_REFILL_lane0 = (LsuL1Plugin_logic_ls_ctrl_refillHazards | (((! execute_ctrl3_down_LsuL1_HAZARD_lane0) && (LsuL1Plugin_logic_ls_ctrl_askRefill || LsuL1Plugin_logic_ls_ctrl_askUpgrade)) ? (LsuL1Plugin_logic_refill_full ? 2'b11 : LsuL1Plugin_logic_refill_free) : 2'b00));
  ...
  assign _zz_21 = {LsuL1Plugin_logic_ls_ctrl_askRefill,{LsuL1Plugin_logic_ls_ctrl_doUpgrade,LsuL1Plugin_logic_ls_ctrl_doFlush}};
  always @(*) begin
  ...
  always @(*) begin
    LsuL1Plugin_logic_shared_write_payload_address = execute_ctrl3_down_LsuL1_MIXED_ADDRESS_lane0[10 : 6];
    if(when_LsuL1Plugin_l1160) begin
  ...
  assign fetch_logic_ctrls_1_down_BtbPlugin_logic_chunksLogic_0_hitCalc_HIT = ((fetch_logic_ctrls_1_down_BtbPlugin_logic_chunksLogic_0_readRsp_ENTRY_hash == fetch_logic_ctrls_1_down_Fetch_WORD_PC[15 : 8]) && 1'b1);
  ...
  assign decode_logic_flushes_2_onLanes_0_doIt = (|{(early0_EnvPlugin_logic_flushPort_valid && 1'b1),{(CsrAccessPlugin_logic_flushPort_valid && 1'b1),{(early0_BranchPlugin_logic_flushPort_valid && 1'b1),(LsuPlugin_logic_flushPort_valid && 1'b1)}}});
  ...
  assign execute_ctrl0_down_lane0_IntFormatPlugin_logic_WIDTH_ID_lane0 = {(|{_zz_execute_ctrl0_down_BYPASSED_AT_2_lane0_1,_zz_execute_ctrl0_down_CsrAccessPlugin_CSR_MASK_lane0}),(|{((execute_lane0_logic_decoding_decodingBits & 32'h00000018) == 32'h00000010),((execute_lane0_logic_decoding_decodingBits & 32'h00001008) == 32'h00001000)})};
  ...
  assign _zz_execute_ctrl0_down_BranchPlugin_BRANCH_CTRL_lane0_1 = {(|_zz_execute_ctrl0_down_lane0_integer_WriteBackPlugin_SEL_lane0),(|_zz_execute_ctrl0_down_BarrelShifterPlugin_IS_W_lane0)};
  ...
  always @(posedge clk or posedge reset) begin
    if(reset) begin
      ...
      if(execute_ctrl3_down_LsuL1_SEL_lane0) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_60 <= 1'b1)); // LsuL1Plugin.scala:L855
          `else
            if(!(_zz_60 <= 1'b1)) begin
      ...
      if(when_LsuL1Plugin_l876) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_62 < 2'b10)); // LsuL1Plugin.scala:L877
          `else
            if(!(_zz_62 < 2'b10)) begin
