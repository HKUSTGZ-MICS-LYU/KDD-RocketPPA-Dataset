...
module VexiiRiscv (
  ...
  wire       [50:0]   _zz_BtbPlugin_logic_readPort_rsp_0_hash;
  ...
  (* ram_style = "block" *) reg [50:0] BtbPlugin_logic_mem [0:63];
  ...
  assign _zz_execute_ctrl1_down_LsuCachelessPlugin_FENCE_lane0_1 = (|((execute_lane0_logic_decoding_decodingBits & 32'h00001058) == 32'h00000008));
  ...
  assign _zz_BtbPlugin_logic_readPort_rsp_0_hash = BtbPlugin_logic_mem_spinal_port1[50 : 0];
