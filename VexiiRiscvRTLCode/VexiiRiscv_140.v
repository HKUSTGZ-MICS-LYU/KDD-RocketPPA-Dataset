...
module VexiiRiscv (
  ...
  (* ram_style = "block" *) reg [43:0] BtbPlugin_logic_mem_symbol0 [0:15];
  (* ram_style = "block" *) reg [43:0] BtbPlugin_logic_mem_symbol1 [0:15];
  ...
  assign _zz_DecoderPlugin_logic_forgetPort_payload_pcOnLastSlice_1 = ((! decode_ctrls_2_down_Prediction_ALIGN_REDO_0) ? _zz_DecoderPlugin_logic_forgetPort_payload_pcOnLastSlice_2 : 2'b00);
  ...
  assign _zz_DecoderPlugin_logic_forgetPort_payload_pcOnLastSlice_2 = ({1'd0,decode_ctrls_2_down_Decode_INSTRUCTION_SLICE_COUNT_0} <<< 1'd1);
  ...
  assign _zz_DecoderPlugin_logic_forgetPort_payload_pcOnLastSlice_4 = ((! decode_ctrls_2_down_Prediction_ALIGN_REDO_1) ? _zz_DecoderPlugin_logic_forgetPort_payload_pcOnLastSlice_5 : 2'b00);
  ...
  assign _zz_DecoderPlugin_logic_forgetPort_payload_pcOnLastSlice_5 = ({1'd0,decode_ctrls_2_down_Decode_INSTRUCTION_SLICE_COUNT_1} <<< 1'd1);
  ...
  always @(*) begin
    ...
    if(DecoderPlugin_logic_laneLogic_1_fixer_doIt) begin
      DecoderPlugin_logic_forgetPort_payload_pcOnLastSlice = (decode_ctrls_2_down_PC_1 + _zz_DecoderPlugin_logic_forgetPort_payload_pcOnLastSlice_3);
    end
  end
