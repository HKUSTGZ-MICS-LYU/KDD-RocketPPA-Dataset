...
module VexiiRiscv (
  ...
  wire       [1:0]    streamArbiter_3_io_output_payload_ctx_GSharePlugin_GSHARE_COUNTER_1;
  ...
  wire       [11:0]   early0_BranchPlugin_logic_jumpLogic_learn_combStage_payload_history;
  wire       [15:0]   early0_BranchPlugin_logic_jumpLogic_learn_combStage_payload_uopId;
  wire       [1:0]    early0_BranchPlugin_logic_jumpLogic_learn_combStage_payload_ctx_GSharePlugin_GSHARE_COUNTER_0;
  wire       [1:0]    early0_BranchPlugin_logic_jumpLogic_learn_combStage_payload_ctx_GSharePlugin_GSHARE_COUNTER_1;
  ...
  wire       [49:0]   _zz_BtbPlugin_logic_readPort_rsp_0_hash;
  ...
  reg [2:0] LsuL1Plugin_logic_shared_mem [0:1];
  ...
  assign _zz_early0_BranchPlugin_logic_jumpLogic_history_fromFetch_shifter_1 = {early0_BranchPlugin_logic_jumpLogic_history_fromFetch_shifter,execute_ctrl2_down_Prediction_ALIGNED_SLICES_TAKEN_lane0[0]};
  assign _zz_early0_BranchPlugin_logic_jumpLogic_history_fromFetch_shifter_2 = {early0_BranchPlugin_logic_jumpLogic_history_fromFetch_shifter_1,execute_ctrl2_down_early0_BranchPlugin_logic_jumpLogic_COND_lane0};
  ...
  assign _zz_execute_ctrl1_down_early0_IntAluPlugin_SEL_lane0_1 = (|{_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_1,{((execute_lane0_logic_decoding_decodingBits & 32'h0000004c) == 32'h00000004),_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0}});
  ...
  assign _zz_execute_ctrl1_down_CsrAccessPlugin_SEL_lane0_1 = (|{((execute_lane0_logic_decoding_decodingBits & 32'h00001050) == 32'h00001050),_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_1_ENABLE_lane0});
  ...
  assign _zz_execute_ctrl1_down_MAY_FLUSH_PRECISE_3_lane0_1 = (|_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_2_ENABLE_lane0);
  ...
  assign _zz_36 = {_zz_execute_ctrl4_down_LsuL1Plugin_logic_MUXED_DATA_lane0_1,_zz_execute_ctrl4_down_LsuL1Plugin_logic_MUXED_DATA_lane0};
  assign _zz_38 = {_zz_20[2],{_zz_20[1],_zz_20[0]}};
  ...
  StreamArbiter_2 streamArbiter_3 (
    ...
    .io_inputs_0_payload_history                           (early0_BranchPlugin_logic_jumpLogic_learn_combStage_payload_history[11:0]                         ), //i
    .io_inputs_0_payload_uopId                             (early0_BranchPlugin_logic_jumpLogic_learn_combStage_payload_uopId[15:0]                           ), //i
    .io_inputs_0_payload_ctx_GSharePlugin_GSHARE_COUNTER_0 (early0_BranchPlugin_logic_jumpLogic_learn_combStage_payload_ctx_GSharePlugin_GSHARE_COUNTER_0[1:0]), //i
    .io_inputs_0_payload_ctx_GSharePlugin_GSHARE_COUNTER_1 (early0_BranchPlugin_logic_jumpLogic_learn_combStage_payload_ctx_GSharePlugin_GSHARE_COUNTER_1[1:0]), //i
    ...
    .io_output_payload_ctx_GSharePlugin_GSHARE_COUNTER_1   (streamArbiter_3_io_output_payload_ctx_GSharePlugin_GSHARE_COUNTER_1[1:0]                          ), //o
  ...
  assign _zz_20 = {LsuL1Plugin_logic_ls_ctrl_askRefill,{LsuL1Plugin_logic_ls_ctrl_doUpgrade,LsuL1Plugin_logic_ls_ctrl_doFlush}};
  always @(*) begin
  ...
  assign _zz_22 = ({1'd0,1'b1} <<< FetchCachelessPlugin_logic_buffer_reserveId_value);
  always @(*) begin
  ...
  assign _zz_23 = ({1'd0,1'b1} <<< FetchCachelessPlugin_logic_bus_rsp_payload_id);
  ...
  assign early0_BranchPlugin_logic_jumpLogic_history_fromFetch_slice = execute_ctrl2_down_PC_lane0[2 : 2];
  assign early0_BranchPlugin_logic_jumpLogic_history_fromFetch_shifter = execute_ctrl2_down_Prediction_BRANCH_HISTORY_lane0;
  assign when_BranchPlugin_l206 = ((early0_BranchPlugin_logic_jumpLogic_history_fromFetch_slice < 1'b0) && execute_ctrl2_down_Prediction_ALIGNED_SLICES_BRANCH_lane0[0]);
  ...
  assign early0_BranchPlugin_logic_jumpLogic_learn_combStage_payload_history = early0_BranchPlugin_logic_jumpLogic_learn_payload_history;
  ...
  assign early0_BranchPlugin_logic_jumpLogic_learn_combStage_payload_ctx_GSharePlugin_GSHARE_COUNTER_0 = early0_BranchPlugin_logic_jumpLogic_learn_payload_ctx_GSharePlugin_GSHARE_COUNTER_0;
  assign early0_BranchPlugin_logic_jumpLogic_learn_combStage_payload_ctx_GSharePlugin_GSHARE_COUNTER_1 = early0_BranchPlugin_logic_jumpLogic_learn_payload_ctx_GSharePlugin_GSHARE_COUNTER_1;
  ...
  assign io_output_combStage_payload_ctx_GSharePlugin_GSHARE_COUNTER_1 = streamArbiter_3_io_output_payload_ctx_GSharePlugin_GSHARE_COUNTER_1;
  ...
  assign BtbPlugin_logic_onLearn_hash = LearnPlugin_logic_learn_payload_pcOnLastSlice[27 : 12];
  always @(*) begin
  ...
  assign BtbPlugin_logic_onForget_hash = DecoderPlugin_logic_forgetPort_payload_pcOnLastSlice[27 : 12];
  assign _zz_BtbPlugin_logic_readPort_rsp_0_hash = BtbPlugin_logic_mem_spinal_port1[49 : 0];
  ...
  assign BtbPlugin_logic_readPort_rsp_0_pcTarget = _zz_BtbPlugin_logic_readPort_rsp_0_hash[46 : 17];
  assign BtbPlugin_logic_readPort_rsp_0_isBranch = _zz_BtbPlugin_logic_readPort_rsp_0_hash[47];
  assign BtbPlugin_logic_readPort_rsp_0_isPush = _zz_BtbPlugin_logic_readPort_rsp_0_hash[48];
  assign BtbPlugin_logic_readPort_rsp_0_isPop = _zz_BtbPlugin_logic_readPort_rsp_0_hash[49];
  ...
  assign _zz_39 = zz_FetchCachelessPlugin_logic_trapPort_payload_arg(1'b0);
  always @(*) FetchCachelessPlugin_logic_trapPort_payload_arg = _zz_39;
  ...
  assign _zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0 = ((execute_lane0_logic_decoding_decodingBits & 32'h00001050) == 32'h00000010);
  ...
  assign _zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_2 = ((execute_lane0_logic_decoding_decodingBits & 32'h00000050) == 32'h00000040);
  always @(*) begin
  ...
  assign _zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_3 = ((execute_lane0_logic_decoding_decodingBits & 32'h0000000c) == 32'h00000004);
  always @(*) begin
  ...
  assign _zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_4 = ((execute_lane0_logic_decoding_decodingBits & 32'h00003040) == 32'h00000040);
  ...
  assign _zz_execute_ctrl1_down_BranchPlugin_BRANCH_CTRL_lane0_1 = {(|_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_3),(|((execute_lane0_logic_decoding_decodingBits & 32'h00000008) == 32'h00000008))};
  ...
  assign TrapPlugin_logic_initHold = (|{(! CsrRamPlugin_logic_flush_done),{((! LsuL1Plugin_logic_initializer_done) || 1'b0),{(! integer_RegFilePlugin_logic_initalizer_done),{1'b0,1'b0}}}});
  ...
  always @(posedge clk or posedge reset) begin
    if(reset) begin
      ...
      if(execute_ctrl4_down_LsuL1_SEL_lane0) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_35 <= 2'b01)); // LsuL1Plugin.scala:L855
          `else
            if(!(_zz_35 <= 2'b01)) begin
      ...
      if(when_LsuL1Plugin_l876) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_37 < 2'b10)); // LsuL1Plugin.scala:L877
          `else
            if(!(_zz_37 < 2'b10)) begin
