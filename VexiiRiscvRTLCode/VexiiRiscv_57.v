...
module VexiiRiscv (
  ...
  reg        [23:0]   FetchL1Plugin_logic_ways_2_mem_spinal_port1;
  reg        [23:0]   FetchL1Plugin_logic_ways_3_mem_spinal_port1;
  ...
  wire       [23:0]   _zz_FetchL1Plugin_logic_ways_2_mem_port;
  wire                _zz_FetchL1Plugin_logic_ways_2_mem_port_1;
  wire       [23:0]   _zz_FetchL1Plugin_logic_ways_3_mem_port;
  ...
  reg        [21:0]   fetch_logic_ctrls_2_up_FetchL1Plugin_logic_WAYS_TAGS_2_address;
  ...
  reg        [21:0]   fetch_logic_ctrls_2_up_FetchL1Plugin_logic_WAYS_TAGS_3_address;
  ...
  wire       [21:0]   fetch_logic_ctrls_2_down_FetchL1Plugin_logic_WAYS_TAGS_2_address;
  ...
  wire       [21:0]   fetch_logic_ctrls_2_down_FetchL1Plugin_logic_WAYS_TAGS_3_address;
  ...
  wire       [21:0]   fetch_logic_ctrls_1_down_FetchL1Plugin_logic_WAYS_TAGS_2_address;
  ...
  wire       [21:0]   fetch_logic_ctrls_1_down_FetchL1Plugin_logic_WAYS_TAGS_3_address;
  reg                 _zz_3;
  reg                 _zz_4;
  reg                 _zz_5;
  ...
  reg        [3:0]    LsuL1Plugin_logic_banksWrite_address;
  ...
  wire       [3:0]    LsuL1Plugin_logic_banks_0_write_payload_address;
  ...
  reg        [3:0]    LsuL1Plugin_logic_banks_0_read_cmd_payload;
  ...
  wire       [3:0]    LsuL1Plugin_logic_banks_1_write_payload_address;
  ...
  reg        [3:0]    LsuL1Plugin_logic_banks_1_read_cmd_payload;
  ...
  wire       [3:0]    LsuL1Plugin_logic_banks_2_write_payload_address;
  ...
  reg        [3:0]    LsuL1Plugin_logic_banks_2_read_cmd_payload;
  ...
  wire       [3:0]    LsuL1Plugin_logic_banks_3_write_payload_address;
  ...
  reg        [3:0]    LsuL1Plugin_logic_banks_3_read_cmd_payload;
  ...
  wire       [3:0]    LsuL1Plugin_logic_ls_rb0_readAddress;
  ...
  wire       [7:0]    FetchL1Plugin_logic_banks_2_write_payload_address;
  wire       [31:0]   FetchL1Plugin_logic_banks_2_write_payload_data;
  wire                FetchL1Plugin_logic_banks_2_read_cmd_valid;
  wire       [7:0]    FetchL1Plugin_logic_banks_2_read_cmd_payload;
  ...
  wire       [7:0]    FetchL1Plugin_logic_banks_3_write_payload_address;
  wire       [31:0]   FetchL1Plugin_logic_banks_3_write_payload_data;
  wire                FetchL1Plugin_logic_banks_3_read_cmd_valid;
  wire       [7:0]    FetchL1Plugin_logic_banks_3_read_cmd_payload;
  ...
  wire       [3:0]    FetchL1Plugin_logic_ways_2_read_cmd_payload;
  ...
  (* keep , syn_keep *) wire       [21:0]   FetchL1Plugin_logic_ways_2_read_rsp_address /* synthesis syn_keep = 1 */ ;
  wire       [23:0]   _zz_FetchL1Plugin_logic_ways_2_read_rsp_loaded;
  wire                FetchL1Plugin_logic_ways_3_read_cmd_valid;
  wire       [3:0]    FetchL1Plugin_logic_ways_3_read_cmd_payload;
  ...
  (* keep , syn_keep *) wire       [21:0]   FetchL1Plugin_logic_ways_3_read_rsp_address /* synthesis syn_keep = 1 */ ;
  wire       [23:0]   _zz_FetchL1Plugin_logic_ways_3_read_rsp_loaded;
  ...
  reg [7:0] LsuL1Plugin_logic_banks_0_mem_symbol0 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_0_mem_symbol1 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_0_mem_symbol2 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_0_mem_symbol3 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_0_mem_symbol4 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_0_mem_symbol5 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_0_mem_symbol6 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_0_mem_symbol7 [0:15];
  ...
  reg [7:0] LsuL1Plugin_logic_banks_1_mem_symbol0 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_1_mem_symbol1 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_1_mem_symbol2 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_1_mem_symbol3 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_1_mem_symbol4 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_1_mem_symbol5 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_1_mem_symbol6 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_1_mem_symbol7 [0:15];
  ...
  reg [7:0] LsuL1Plugin_logic_banks_2_mem_symbol0 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_2_mem_symbol1 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_2_mem_symbol2 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_2_mem_symbol3 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_2_mem_symbol4 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_2_mem_symbol5 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_2_mem_symbol6 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_2_mem_symbol7 [0:15];
  ...
  reg [7:0] LsuL1Plugin_logic_banks_3_mem_symbol0 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_3_mem_symbol1 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_3_mem_symbol2 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_3_mem_symbol3 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_3_mem_symbol4 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_3_mem_symbol5 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_3_mem_symbol6 [0:15];
  reg [7:0] LsuL1Plugin_logic_banks_3_mem_symbol7 [0:15];
  ...
  reg [6:0] LsuL1Plugin_logic_shared_mem [0:1];
  ...
  reg [31:0] FetchL1Plugin_logic_banks_2_mem [0:255];
  reg [31:0] FetchL1Plugin_logic_banks_3_mem [0:255];
  reg [23:0] FetchL1Plugin_logic_ways_0_mem [0:15];
  reg [23:0] FetchL1Plugin_logic_ways_1_mem [0:15];
  reg [23:0] FetchL1Plugin_logic_ways_2_mem [0:15];
  reg [23:0] FetchL1Plugin_logic_ways_3_mem [0:15];
  reg [2:0] FetchL1Plugin_logic_plru_mem [0:15];
  ...
  assign _zz_65 = _zz_execute_ctrl4_down_LsuL1Plugin_logic_MUXED_DATA_lane0_3;
  assign _zz_64 = {2'd0, _zz_65};
  ...
  assign _zz_execute_ctrl1_down_lane0_IntFormatPlugin_logic_SIGNED_lane0_1 = (|{_zz_execute_ctrl1_down_IterativeShifterPlugin_IS_W_lane0,((execute_lane0_logic_decoding_decodingBits & 32'h00004010) == 32'h0)});
  assign _zz_execute_ctrl1_down_BYPASSED_AT_2_lane0 = _zz_execute_ctrl1_down_BYPASSED_AT_2_lane0_1[0];
  assign _zz_execute_ctrl1_down_BYPASSED_AT_2_lane0_1 = (|{_zz_execute_ctrl1_down_early0_IntAluPlugin_ALU_ADD_SUB_lane0,{_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_1,_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0}});
  ...
  assign _zz_execute_ctrl1_down_IterativeShifterPlugin_IS_W_RIGHT_lane0_1 = (|((execute_lane0_logic_decoding_decodingBits & 32'h00004008) == 32'h00004008));
  ...
  assign _zz_67 = {_zz_37[2],{_zz_37[1],_zz_37[0]}};
  ...
  always @(*) begin
    case(_zz_62)
      3'b000 : _zz_61 = _zz_29;
      3'b001 : _zz_61 = _zz_30;
      3'b010 : _zz_61 = _zz_31;
      3'b011 : _zz_61 = _zz_32;
      3'b100 : _zz_61 = _zz_33;
      3'b101 : _zz_61 = _zz_34;
      3'b110 : _zz_61 = _zz_35;
      default : _zz_61 = _zz_36;
    endcase
  end

  always @(*) begin
    case(_zz_64)
      3'b000 : _zz_63 = _zz_29;
      3'b001 : _zz_63 = _zz_30;
      3'b010 : _zz_63 = _zz_31;
      3'b011 : _zz_63 = _zz_32;
      3'b100 : _zz_63 = _zz_33;
      3'b101 : _zz_63 = _zz_34;
      3'b110 : _zz_63 = _zz_35;
      default : _zz_63 = _zz_36;
    endcase
  end
  ...
  always @(*) begin
    LsuL1Plugin_logic_banksWrite_address = 4'bxxxx;
    ...
    if(LsuL1Plugin_logic_ls_ctrl_bankWriteReservation_win) begin
      LsuL1Plugin_logic_banksWrite_address = execute_ctrl4_down_LsuL1_PHYSICAL_ADDRESS_lane0[6 : 3];
    end
  end
  ...
  assign LsuL1Plugin_logic_ls_rb0_readAddress = execute_ctrl2_down_LsuL1_MIXED_ADDRESS_lane0[6 : 3];
  always @(*) begin
  ...
  assign LsuL1Plugin_logic_ls_ctrl_refillHazards = {(LsuL1Plugin_logic_refill_slots_1_valid && (LsuL1Plugin_logic_refill_slots_1_address[6 : 6] == execute_ctrl4_down_LsuL1_PHYSICAL_ADDRESS_lane0[6 : 6])),(LsuL1Plugin_logic_refill_slots_0_valid && (LsuL1Plugin_logic_refill_slots_0_address[6 : 6] == execute_ctrl4_down_LsuL1_PHYSICAL_ADDRESS_lane0[6 : 6]))};
  assign LsuL1Plugin_logic_ls_ctrl_writebackHazards = {(LsuL1Plugin_logic_writeback_slots_1_valid && (LsuL1Plugin_logic_writeback_slots_1_address[6 : 6] == execute_ctrl4_down_LsuL1_PHYSICAL_ADDRESS_lane0[6 : 6])),(LsuL1Plugin_logic_writeback_slots_0_valid && (LsuL1Plugin_logic_writeback_slots_0_address[6 : 6] == execute_ctrl4_down_LsuL1_PHYSICAL_ADDRESS_lane0[6 : 6]))};
  ...
  assign _zz_37 = {LsuL1Plugin_logic_ls_ctrl_askRefill,{LsuL1Plugin_logic_ls_ctrl_doUpgrade,LsuL1Plugin_logic_ls_ctrl_doFlush}};
  always @(*) begin
  ...
  assign FetchL1Plugin_logic_ways_2_read_rsp_address = _zz_FetchL1Plugin_logic_ways_2_read_rsp_loaded[23 : 2];
  ...
  assign FetchL1Plugin_logic_ways_3_read_rsp_address = _zz_FetchL1Plugin_logic_ways_3_read_rsp_loaded[23 : 2];
  ...
  assign FetchL1Plugin_logic_banks_2_write_payload_address = {FetchL1Plugin_logic_refill_onRsp_address[9 : 6],FetchL1Plugin_logic_refill_onRsp_wordIndex};
  ...
  assign FetchL1Plugin_logic_banks_3_write_payload_address = {FetchL1Plugin_logic_refill_onRsp_address[9 : 6],FetchL1Plugin_logic_refill_onRsp_wordIndex};
  ...
  assign FetchL1Plugin_logic_banks_2_read_cmd_payload = fetch_logic_ctrls_0_down_Fetch_WORD_PC[9 : 2];
  assign FetchL1Plugin_logic_banks_3_read_cmd_valid = FetchL1Plugin_logic_cmd_doIt;
  assign FetchL1Plugin_logic_banks_3_read_cmd_payload = fetch_logic_ctrls_0_down_Fetch_WORD_PC[9 : 2];
  ...
  assign FetchL1Plugin_logic_ways_2_read_cmd_payload = fetch_logic_ctrls_0_down_Fetch_WORD_PC[9 : 6];
  assign FetchL1Plugin_logic_ways_3_read_cmd_valid = FetchL1Plugin_logic_cmd_doIt;
  assign FetchL1Plugin_logic_ways_3_read_cmd_payload = fetch_logic_ctrls_0_down_Fetch_WORD_PC[9 : 6];
  ...
  assign fetch_logic_ctrls_1_down_FetchL1Plugin_logic_WAYS_HITS_2 = (fetch_logic_ctrls_1_down_FetchL1Plugin_logic_WAYS_TAGS_2_loaded && (fetch_logic_ctrls_1_down_FetchL1Plugin_logic_WAYS_TAGS_2_address == fetch_logic_ctrls_1_down_MMU_TRANSLATED[31 : 10]));
  assign fetch_logic_ctrls_1_down_FetchL1Plugin_logic_WAYS_HITS_3 = (fetch_logic_ctrls_1_down_FetchL1Plugin_logic_WAYS_TAGS_3_loaded && (fetch_logic_ctrls_1_down_FetchL1Plugin_logic_WAYS_TAGS_3_address == fetch_logic_ctrls_1_down_MMU_TRANSLATED[31 : 10]));
  ...
  assign _zz_68 = zz_FetchL1Plugin_logic_trapPort_payload_arg(1'b0);
  always @(*) FetchL1Plugin_logic_trapPort_payload_arg = _zz_68;
  always @(*) begin
  ...
  assign _zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_5 = ((execute_lane0_logic_decoding_decodingBits & 32'h00001018) == 32'h00001008);
  always @(*) begin
  ...
  assign _zz_execute_ctrl1_down_IterativeShifterPlugin_IS_W_lane0 = ((execute_lane0_logic_decoding_decodingBits & 32'h00000008) == 32'h00000008);
  ...
  assign execute_ctrl1_down_lane0_IntFormatPlugin_logic_WIDTH_ID_lane0 = {(|{_zz_execute_ctrl1_down_BYPASSED_AT_3_lane0_1,_zz_execute_ctrl1_down_CsrAccessPlugin_CSR_MASK_lane0}),(|{((execute_lane0_logic_decoding_decodingBits & 32'h00000018) == 32'h00000010),((execute_lane0_logic_decoding_decodingBits & 32'h00001008) == 32'h00001000)})};
  ...
  assign _zz_execute_ctrl1_down_BranchPlugin_BRANCH_CTRL_lane0_1 = {(|_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_3),(|_zz_execute_ctrl1_down_IterativeShifterPlugin_IS_W_lane0)};
  ...
  always @(posedge clk or posedge reset) begin
    if(reset) begin
      ...
      if(execute_ctrl4_down_LsuL1_SEL_lane0) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_60 <= 3'b001)); // LsuL1Plugin.scala:L855
          `else
            if(!(_zz_60 <= 3'b001)) begin
      ...
      if(when_LsuL1Plugin_l876) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_66 < 2'b10)); // LsuL1Plugin.scala:L877
          `else
            if(!(_zz_66 < 2'b10)) begin
