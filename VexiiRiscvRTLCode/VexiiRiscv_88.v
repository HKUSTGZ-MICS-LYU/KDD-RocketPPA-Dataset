...
module VexiiRiscv (
  ...
  reg [2:0] LsuL1Plugin_logic_shared_mem [0:127];
  ...
  assign _zz_38 = {_zz_execute_ctrl4_down_LsuL1Plugin_logic_MUXED_DATA_lane0_1,_zz_execute_ctrl4_down_LsuL1Plugin_logic_MUXED_DATA_lane0};
  assign _zz_40 = {_zz_20[2],{_zz_20[1],_zz_20[0]}};
  ...
  assign _zz_41 = zz_FetchL1Plugin_logic_trapPort_payload_arg(1'b0);
  always @(*) FetchL1Plugin_logic_trapPort_payload_arg = _zz_41;
  always @(*) begin
  ...
  always @(posedge clk or posedge reset) begin
    if(reset) begin
      ...
      if(execute_ctrl4_down_LsuL1_SEL_lane0) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_37 <= 2'b01)); // LsuL1Plugin.scala:L855
          `else
            if(!(_zz_37 <= 2'b01)) begin
      ...
      if(when_LsuL1Plugin_l876) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_39 < 2'b10)); // LsuL1Plugin.scala:L877
          `else
            if(!(_zz_39 < 2'b10)) begin
