...
module VexiiRiscv (
  ...
  reg        [43:0]   BtbPlugin_logic_mem_spinal_port1;
  ...
  wire       [43:0]   _zz_BtbPlugin_logic_mem_port;
  ...
  wire       [0:0]    execute_ctrl2_down_LsuPlugin_SB_PTR_lane0;
  ...
  reg        [0:0]    execute_ctrl3_up_LsuPlugin_SB_PTR_lane0;
  ...
  reg        [0:0]    execute_ctrl2_up_LsuPlugin_SB_PTR_lane0;
  ...
  wire       [0:0]    execute_ctrl3_down_LsuPlugin_SB_PTR_lane0;
  ...
  wire       [0:0]    execute_ctrl1_down_LsuPlugin_SB_PTR_lane0;
  ...
  reg        [0:0]    LsuPlugin_logic_storeBuffer_ops_ctrls_1_up_SB_PTR;
  wire                LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_isReady;
  wire       [0:0]    LsuPlugin_logic_storeBuffer_ops_ctrls_0_down_SB_PTR;
  ...
  wire       [0:0]    LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_SB_PTR;
  ...
  wire       [0:0]    LsuPlugin_logic_storeBuffer_ops_ctrls_0_up_SB_PTR;
  ...
  wire       [0:0]    LsuPlugin_logic_storeBuffer_pop_payload_ptr;
  ...
  reg        [0:0]    LsuPlugin_logic_storeBuffer_ops_pushPtr;
  reg        [0:0]    LsuPlugin_logic_storeBuffer_ops_popPtr;
  reg        [0:0]    LsuPlugin_logic_storeBuffer_ops_freePtr;
  wire                LsuPlugin_logic_storeBuffer_ops_full;
  wire       [0:0]    LsuPlugin_logic_storeBuffer_ops_occupancy;
  wire       [109:0]  _zz_LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_address;
  wire                when_StageLink_l67;
  reg                 LsuPlugin_logic_storeBuffer_slots_0_valid;
  reg        [0:0]    LsuPlugin_logic_storeBuffer_slots_0_ptr;
  reg        [5:0]    LsuPlugin_logic_storeBuffer_slots_0_tag;
  reg                 LsuPlugin_logic_storeBuffer_slots_1_valid;
  reg        [0:0]    LsuPlugin_logic_storeBuffer_slots_1_ptr;
  ...
  wire       [43:0]   _zz_BtbPlugin_logic_readPort_rsp_0_hash;
  ...
  reg        [109:0]  _zz_LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_address_2;
  reg        [109:0]  _zz_LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_address_3;
  `ifndef SYNTHESIS
  ...
  reg [7:0] LsuL1Plugin_logic_banks_0_mem_symbol4 [0:31];
  reg [7:0] LsuL1Plugin_logic_banks_0_mem_symbol5 [0:31];
  reg [7:0] LsuL1Plugin_logic_banks_0_mem_symbol6 [0:31];
  reg [7:0] LsuL1Plugin_logic_banks_0_mem_symbol7 [0:31];
  ...
  reg [7:0] LsuL1Plugin_logic_banks_1_mem_symbol4 [0:31];
  reg [7:0] LsuL1Plugin_logic_banks_1_mem_symbol5 [0:31];
  reg [7:0] LsuL1Plugin_logic_banks_1_mem_symbol6 [0:31];
  reg [7:0] LsuL1Plugin_logic_banks_1_mem_symbol7 [0:31];
  ...
  reg [2:0] LsuL1Plugin_logic_shared_mem [0:3];
  ...
  (* ram_style = "block" *) reg [43:0] BtbPlugin_logic_mem [0:63];
  ...
  assign _zz_execute_ctrl0_down_early0_IntAluPlugin_SEL_lane0_1 = (|{_zz_execute_ctrl0_down_BYPASSED_AT_1_lane0_1,{_zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_1,{_zz_execute_ctrl0_down_BYPASSED_AT_1_lane0,{_zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0,((execute_lane0_logic_decoding_decodingBits & 32'h02001050) == 32'h00000010)}}}});
  ...
  assign _zz_execute_ctrl0_down_early0_EnvPlugin_SEL_lane0_1 = (|{_zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_2,((execute_lane0_logic_decoding_decodingBits & 32'h00003050) == 32'h00000050)});
  ...
  assign _zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_5 = (|{_zz_execute_ctrl0_down_BYPASSED_AT_1_lane0_1,{_zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_1,{_zz_execute_ctrl0_down_BYPASSED_AT_1_lane0,{_zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_2,{_zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0,_zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_3}}}}});
  assign _zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_1_ENABLE_lane0_5 = _zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_1_ENABLE_lane0_6[0];
  assign _zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_1_ENABLE_lane0_6 = (|{_zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_1_ENABLE_lane0_4,{_zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_1_ENABLE_lane0_3,{_zz_execute_ctrl0_down_MAY_FLUSH_PRECISE_2_lane0,{_zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_1_ENABLE_lane0_2,{_zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_1_ENABLE_lane0,_zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_1_ENABLE_lane0_1}}}}});
  ...
  assign _zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_2_ENABLE_lane0_3 = (|{_zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_2_ENABLE_lane0,{_zz_execute_ctrl0_down_MAY_FLUSH_PRECISE_3_lane0,_zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_2_ENABLE_lane0_1}});
  ...
  assign _zz_30 = {_zz_execute_ctrl3_down_LsuL1Plugin_logic_MUXED_DATA_lane0_1,_zz_execute_ctrl3_down_LsuL1Plugin_logic_MUXED_DATA_lane0};
  assign _zz_32 = {_zz_18[2],{_zz_18[1],_zz_18[0]}};
  ...
  always @(*) begin
    ...
    if(LsuL1Plugin_logic_ls_ctrl_bankWriteReservation_win) begin
      LsuL1Plugin_logic_banksWrite_address = execute_ctrl3_down_LsuL1_PHYSICAL_ADDRESS_lane0[7 : 3];
    end
  end
  ...
  assign LsuL1Plugin_logic_ls_rb0_readAddress = execute_ctrl1_down_LsuL1_MIXED_ADDRESS_lane0[7 : 3];
  always @(*) begin
  ...
  assign LsuL1Plugin_logic_ls_ctrl_writebackHazards = (LsuL1Plugin_logic_writeback_slots_0_valid && (LsuL1Plugin_logic_writeback_slots_0_address[7 : 6] == execute_ctrl3_down_LsuL1_PHYSICAL_ADDRESS_lane0[7 : 6]));
  ...
  assign _zz_18 = {LsuL1Plugin_logic_ls_ctrl_askRefill,{LsuL1Plugin_logic_ls_ctrl_doUpgrade,LsuL1Plugin_logic_ls_ctrl_doFlush}};
  always @(*) begin
  ...
  assign _zz_33 = zz_FetchL1Plugin_logic_trapPort_payload_arg(1'b0);
  always @(*) FetchL1Plugin_logic_trapPort_payload_arg = _zz_33;
  always @(*) begin
  ...
  assign LsuPlugin_logic_storeBuffer_ops_full = (((LsuPlugin_logic_storeBuffer_ops_pushPtr ^ LsuPlugin_logic_storeBuffer_ops_freePtr) ^ 1'b1) == 1'b0);
  ...
  assign _zz_LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_address = _zz_LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_address_2;
  assign LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_address = _zz_LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_address[31 : 0];
  assign LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_data = _zz_LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_address[95 : 32];
  assign LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_size = _zz_LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_address[97 : 96];
  assign LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_storeId = _zz_LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_address[109 : 98];
  ...
  assign when_LsuPlugin_l268 = (LsuPlugin_logic_storeBuffer_slotsFree && (LsuPlugin_logic_storeBuffer_ops_occupancy <= 1'b0));
  ...
  assign lane0_IntFormatPlugin_logic_stages_2_hits = {LsuPlugin_logic_iwb_valid,early0_MulPlugin_logic_formatBus_valid};
  ...
  assign lane0_IntFormatPlugin_logic_stages_2_raw = ((lane0_IntFormatPlugin_logic_stages_2_hits[0] ? early0_MulPlugin_logic_formatBus_payload : 64'h0) | (lane0_IntFormatPlugin_logic_stages_2_hits[1] ? LsuPlugin_logic_iwb_payload : 64'h0));
  always @(*) begin
  ...
  assign _zz_BtbPlugin_logic_readPort_rsp_0_hash = BtbPlugin_logic_mem_spinal_port1[43 : 0];
  assign BtbPlugin_logic_readPort_rsp_0_hash = _zz_BtbPlugin_logic_readPort_rsp_0_hash[7 : 0];
  assign BtbPlugin_logic_readPort_rsp_0_sliceLow = _zz_BtbPlugin_logic_readPort_rsp_0_hash[8 : 8];
  assign BtbPlugin_logic_readPort_rsp_0_pcTarget = _zz_BtbPlugin_logic_readPort_rsp_0_hash[39 : 9];
  assign BtbPlugin_logic_readPort_rsp_0_isBranch = _zz_BtbPlugin_logic_readPort_rsp_0_hash[40];
  assign BtbPlugin_logic_readPort_rsp_0_isPush = _zz_BtbPlugin_logic_readPort_rsp_0_hash[41];
  assign BtbPlugin_logic_readPort_rsp_0_isPop = _zz_BtbPlugin_logic_readPort_rsp_0_hash[42];
  assign BtbPlugin_logic_readPort_rsp_0_taken = _zz_BtbPlugin_logic_readPort_rsp_0_hash[43];
  ...
  assign _zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_1 = ((execute_lane0_logic_decoding_decodingBits & 32'h0000004c) == 32'h00000004);
  ...
  assign _zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_2 = ((execute_lane0_logic_decoding_decodingBits & 32'h00001058) == 32'h00001008);
  always @(*) begin
  ...
  assign _zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_1_ENABLE_lane0_1 = ((execute_lane0_logic_decoding_decodingBits & 32'h02003014) == 32'h00001010);
  ...
  assign _zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_1_ENABLE_lane0_3 = ((execute_lane0_logic_decoding_decodingBits & 32'h00001040) == 32'h00001040);
  assign _zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_1_ENABLE_lane0_4 = ((execute_lane0_logic_decoding_decodingBits & 32'h00002040) == 32'h00002040);
  always @(*) begin
  ...
  always @(*) begin
    execute_ctrl0_down_lane0_logic_completions_onCtrl_1_ENABLE_lane0 = _zz_execute_ctrl0_down_lane0_logic_completions_onCtrl_1_ENABLE_lane0_5[0];
    if(execute_ctrl0_down_TRAP_lane0) begin
  ...
  assign execute_ctrl0_down_early0_SrcPlugin_logic_SRC2_CTRL_lane0 = {(|{_zz_execute_ctrl0_down_BYPASSED_AT_2_lane0,((execute_lane0_logic_decoding_decodingBits & 32'h00000070) == 32'h00000020)}),(|{((execute_lane0_logic_decoding_decodingBits & 32'h00000050) == 32'h0),((execute_lane0_logic_decoding_decodingBits & 32'h00000024) == 32'h0)})};
  ...
  assign when_ExecuteLanePlugin_l300_1 = (|{((early0_EnvPlugin_logic_flushPort_valid && 1'b1) && (1'b0 || (1'b1 && early0_EnvPlugin_logic_flushPort_payload_self))),{((CsrAccessPlugin_logic_flushPort_valid && 1'b1) && (1'b0 || (_zz_when_ExecuteLanePlugin_l300_1 && CsrAccessPlugin_logic_flushPort_payload_self))),{(early0_BranchPlugin_logic_flushPort_valid && 1'b1),(LsuPlugin_logic_flushPort_valid && 1'b1)}}});
  assign execute_lane0_ctrls_1_downIsCancel = 1'b0;
  assign execute_lane0_ctrls_1_upIsCancel = when_ExecuteLanePlugin_l300_1;
  assign when_ExecuteLanePlugin_l300_2 = (|{((early0_BranchPlugin_logic_flushPort_valid && 1'b1) && (1'b0 || (1'b1 && early0_BranchPlugin_logic_flushPort_payload_self))),(LsuPlugin_logic_flushPort_valid && 1'b1)});
  ...
  assign execute_freeze_valid = (|{CsrAccessPlugin_logic_fsm_inject_iLogic_freeze,{LsuPlugin_logic_onCtrl_io_freezeIt,{early0_DivPlugin_logic_processing_freeze,((execute_ctrl3_up_LANE_SEL_lane0 && execute_ctrl3_down_MulPlugin_HIGH_lane0) && (! early0_MulPlugin_logic_writeback_buffer_valid))}}});
  ...
  assign _zz_LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_address_1 = _zz_LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_address_3;
  always @(posedge clk or posedge reset) begin
    if(reset) begin
      ...
      LsuPlugin_logic_storeBuffer_ops_pushPtr <= 1'b0;
      LsuPlugin_logic_storeBuffer_ops_popPtr <= 1'b0;
      LsuPlugin_logic_storeBuffer_ops_freePtr <= 1'b0;
      ...
      if(execute_ctrl3_down_LsuL1_SEL_lane0) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_29 <= 2'b01)); // LsuL1Plugin.scala:L855
          `else
            if(!(_zz_29 <= 2'b01)) begin
      ...
      if(when_LsuL1Plugin_l876) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((_zz_31 < 2'b10)); // LsuL1Plugin.scala:L877
          `else
            if(!(_zz_31 < 2'b10)) begin
      ...
      `ifndef SYNTHESIS
        ...
        `endif
      `endif
      LsuPlugin_logic_storeBuffer_ops_popPtr <= (LsuPlugin_logic_storeBuffer_ops_popPtr + LsuPlugin_logic_storeBuffer_ops_ctrls_0_up_isFiring);
      ...
      if(LsuPlugin_logic_storeBuffer_push_valid) begin
        LsuPlugin_logic_storeBuffer_ops_pushPtr <= (LsuPlugin_logic_storeBuffer_ops_pushPtr + LsuPlugin_logic_storeBuffer_push_valid);
        if(_zz_when_2) begin
      ...
      if(when_LsuPlugin_l776) begin
        if(LsuPlugin_logic_onCtrl_traps_l1Failed) begin
          ...
          LsuPlugin_logic_storeBuffer_ops_freePtr <= (LsuPlugin_logic_storeBuffer_ops_freePtr + 1'b1);
  ...
  always @(posedge clk) begin
    ...
    if(LsuPlugin_logic_storeBuffer_ops_ctrls_0_up_isFiring) begin
      _zz_LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_address_2 <= _zz_LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_address_1;
    end
    if(when_Phase_l774) begin
      _zz_LsuPlugin_logic_storeBuffer_ops_ctrls_1_down_OPS_address_3 <= {LsuPlugin_logic_storeBuffer_push_payload_op_storeId,{LsuPlugin_logic_storeBuffer_push_payload_op_size,{LsuPlugin_logic_storeBuffer_push_payload_op_data,LsuPlugin_logic_storeBuffer_push_payload_op_address}}};
    end
  end
